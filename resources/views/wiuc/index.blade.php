    ...
    <section class="home-slider owl-carousel js-fullheight">
      <div class="slider-item js-fullheight" style="background-image: url('wiuc/images/bg_1.jpg');">
      ...
      <div class="slider-item js-fullheight" style="background-image: url('wiuc/images/bg_2.jpg');">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
      ...
      <div class="slider-item js-fullheight" style="background-image: url('wiuc/images/bg_3.jpg');">
      	<div class="overlay"></div>
        <div class="container">
    				...
    				<div class="featured">
    					<div class="row">
		                  ...
		                  <h3>Grilled Beef with potatoes</h3>
    						...
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image: url('wiuc/images/breakfast-3.jpg');"></div>
			              <div class="text text-center">
		                  <h3>Grilled Beef with potatoes</h3>
				              <p><span>Meat</span>, <span>Potatoes</span>, <span>Rice</span>, <span>Tomatoe</span></p>
			              </div>
    						...
    						<div class="col-md-3">
    							<div class="featured-menus ftco-animate">
			              <div class="menu-img img" style="background-image: url('wiuc/images/breakfast-4.jpg');"></div>
			              <div class="text text-center">
		                  <h3>Grilled Beef with potatoes</h3>
				              <p><span>Meat</span>, <span>Potatoes</span>, <span>Rice</span>, <span>Tomatoe</span></p>
			              </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 d-flex">
						<div class="img img-1 mr-md-2" style="background-image: url('wiuc/images/about.jpg');"></div>
						<div class="img img-2 ml-md-2" style="background-image: url('wiuc/images/about-1.jpg');"></div>
					</div>
    ...
    <section class="ftco-section">
        ...
        <div class="row no-gutters d-flex align-items-stretch">
        	...
        	<div class="col-md-12 col-lg-6 d-flex align-self-stretch">
        		<div class="menus d-sm-flex ftco-animate align-items-stretch">
              <div class="menu-img img order-md-last" style="background-image: url('wiuc/images/breakfast-5.jpg');"></div>
              <div class="text d-flex align-items-center">
								<div>
	              	<div class="d-flex">
		                <div class="one-half">
            ...
            <h2 class="mb-4">Our Master Chef</h2>
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url('wiuc/images/chef-4.jpg');"></div>
							<div class="text pt-4">
								<h3>John Smooth</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url('wiuc/images/chef-2.jpg');"></div>
							<div class="text pt-4">
								<h3>Rebeca Welson</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url('wiuc/images/chef-3.jpg');"></div>
							<div class="text pt-4">
								<h3>Kharl Branyt</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img" style="background-image: url('wiuc/images/chef-1.jpg');"></div>
							<div class="text pt-4">
								<h3>Luke Simon</h3>
								<span class="position mb-2">Chef</span>
								<div class="faded">
		...
		<section class="ftco-section img" style="background-image: url('wiuc/images/bg_3.jpg')" data-stellar-background-ratio="0.5">
			<div class="container">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  <div class="user-img mb-4" style="background-image: url('wiuc/images/person_1.jpg')">
              ...
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  <div class="user-img mb-4" style="background-image: url('wiuc/images/person_2.jpg')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  <div class="user-img mb-4" style="background-image: url('wiuc/images/person_3.jpg')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap text-center pb-5">
                  <div class="user-img mb-4" style="background-image: url('wiuc/images/person_4.jpg')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
		...
		<section class="ftco-section bg-light">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('wiuc/images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('wiuc/images/image_2.jpg');">
              </a>
              <div class="text pt-3 pb-4 px-4">
                <div class="meta">
                  <div><a href="#">Sept. 06, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('wiuc/images/image_3.jpg');">
              </a>
              <div class="text pt-3 pb-4 px-4">
                <div class="meta">
                  <div><a href="#">Sept. 06, 2019</a></div>
