  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="#"><i class="fa fa-dashboard"></i> <span>Chef Dashboard</span></a></li>




        <li class="treeview">
          <a href="{{ url('order-management') }}"><i class="fa fa-truck"></i> <span>Order Details</span>
